...
{
    resize(850, 550);
    setWindowTitle(tr("IntelligentAssets") + " - " + tr("Wallet"));
#ifndef Q_OS_MAC
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a IntelligentAssets address"));
    ...
    aboutAction = new QAction(QIcon(":/icons/bitcoin"), tr("&About IntelligentAssets"), this);
    aboutAction->setToolTip(tr("Show information about IntelligentAssets"));
    ...
    optionsAction->setToolTip(tr("Modify configuration options for IntelligentAssets"));
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("IntelligentAssets client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("IntelligentAssets client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to IntelligentAssets network.", "", count));
}
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid IntelligentAssets address or malformed URI parameters."));
    }
