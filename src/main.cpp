...
int64 nChainStartTime = 1495519695;
...
const string strMessageMagic = "IntelligentAssets Signed Message:\n";
...
int64 GetProofOfWorkReward(int nHeight, int64 nFees, const CBlockIndex* pindex)
{
     ...
     if (nPoWHeight == 1)
       nSubsidy = 22000000 * COIN; //Premin: 10M
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in IntelligentAssets
    bool fStrictPayToScriptHash = true; // Always active in IntelligentAssets
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "IntelligentAssets", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Intelligent Assets is upcoming release wish is a great coin!";
        CTransaction txNew;
      ...
      if (true  && (block.GetHash() != hashGenesisBlock))
        ...
        assert(block.hashMerkleRoot == uint256("0x0ca9df48bdfa8a5549c9d68607a819b8bf8a8e5dee86a014ecf8b45062e14066"));
...
unsigned char pchMessageStart[4] = { 0xf2, 0x3c, 0xf3, 0xa6 };
